---
title: Frontend
description: Wire a React chat UI to the agent with useAgentChat — the AI SDK v7 transport, threads, personas, quota, cancel, HITL approve/reject, and styling-agnostic components.
---
