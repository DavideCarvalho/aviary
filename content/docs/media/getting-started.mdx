...
The `TypeOrmMediaStore` creates the `media` table on first use by default (non-destructive — see [ORM stores](/docs/media/packages/orm-stores)). Nothing else to migrate to get started.
