...
Adds the **[attachment column model](/docs/media/concepts/attachments)** (adonis-attachment style) alongside the existing media table, and an owner-binding ergonomic for the table model.
