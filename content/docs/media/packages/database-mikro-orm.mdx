...
`@mikro-orm/core` (^6) and `@dudousxd/nestjs-media-core` — plus your driver package (`@mikro-orm/postgresql`, `@mikro-orm/mysql`, `@mikro-orm/better-sqlite`, …). See [Concepts → Persistence](/docs/media/concepts/persistence).
