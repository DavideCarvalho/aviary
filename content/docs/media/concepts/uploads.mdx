...
The [React package](/docs/media/packages/colas) and the [codegen client](/docs/media/packages/colas) both ship `uploadMedia()` — it POSTs to create the upload, PATCHes chunks with offset tracking, resumes on failure, and reports progress:
