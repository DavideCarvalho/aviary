...
The [React package](/docs/media/packages/react) and the [codegen client](/docs/media/packages/codegen) both ship `uploadMedia()` — it POSTs to create the upload, PATCHes chunks with offset tracking, resumes on failure, and reports progress:
