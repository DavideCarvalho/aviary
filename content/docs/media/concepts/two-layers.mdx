...
The `media` table is polymorphic and managed by your chosen [ORM store](/docs/media/packages/orm-stores) — TypeORM, MikroORM, Drizzle, or Prisma, all behind the same `MediaStore` contract.
