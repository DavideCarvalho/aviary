...
`InMemoryUploadSessionStore` lets you exercise the [resumable engine](/docs/media/concepts/uploads) (`media.uploads`) end to end in memory.

<Callout type="info">
The same package exports the [conformance suites](/docs/media/packages/testing) — use those to test custom [drivers](/docs/media/recipes/custom-driver) and [stores](/docs/media/recipes/custom-store).
</Callout>
