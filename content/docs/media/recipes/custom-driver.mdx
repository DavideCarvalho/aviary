...
The same approach applies to a custom `MediaStore` (implement the interface, verify with `runMediaStoreConformance`) — see [Custom store](/docs/media/recipes/custom-store).
