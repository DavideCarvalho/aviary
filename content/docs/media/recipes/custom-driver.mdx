...
The same approach applies to a custom `MediaStore` (implement the interface, verify with `runMediaStoreConformance`) — see [ORM stores](/docs/media/packages/orm-stores).
