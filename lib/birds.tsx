...
const art: Record<string, ReactElement> = {
  Falcon: (
    <g>
      <path
        d="M-4 -30 C-40 -26 -78 -36 -96 -10 C-66 -16 -36 -4 -8 6 Z"
        fill={C}
      />
      <path d="M4 -30 C40 -26 78 -36 96 -10 C66 -16 36 -4 8 6 Z" fill={C} />
      <path
        d="M-8 -34 C-3 -40 3 -40 8 -34 C10 2 6 36 0 54 C-6 36 -10 2 -8 -34 Z"
        fill={C}
      />
  ...
  Weaver: (
    <g>
      <path
        d="M-16 -16 C-20 -32 -6 -42 10 -38 C24 -34 24 -18 12 -12 C2 -8 -8 -6 -16 -16 Z"
        fill={C}
      />
  ...
  Swift: (
    <g>
      ...
      <path
        d="M-7 -14 C-2 -18 2 -18 7 -14 C9 8 6 34 0 52 C-6 34 -9 8 -7 -14 Z"
        fill={C}
      />
    </g>
  ),
  ...
  Sandpiper: (
    <g>
      ...
      <path
        d="M-5 47 l-6 4 M-5 47 l6 3 M21 47 l-6 4 M21 47 l6 3"
        stroke={C}
        strokeWidth="2.5"
        strokeLinecap="round"
      />
  ...
  Swallow: (
    <g>
      <path
        d="M-2 -4 C-34 -24 -66 -22 -90 -8 C-64 -10 -36 -2 -6 6 Z"
        fill={C}
      />
      <path d="M2 -4 C34 -24 66 -22 90 -8 C64 -10 36 -2 6 6 Z" fill={C} />
      <path
        d="M-6 -10 C0 -14 6 -10 6 -10 C7 8 6 24 4 32 L13 52 L0 41 L-13 52 L-4 32 C-6 24 -7 8 -6 -10 Z"
        fill={C}
      />
    </g>
  ),
  Nightingale: (
    <g>
      <path
        d="M-18 8 C-22 -16 -4 -30 14 -24 C30 -18 30 4 18 12 C8 18 -6 20 -18 8 Z"
        fill={C}
      />
  ...
  Owl: (
    <g>
      ...
      <path
        d="M0 -52 C34 -52 50 -26 50 4 C50 40 30 60 0 60 C-30 60 -50 40 -50 4 C-50 -26 -34 -52 0 -52 Z"
        fill={C}
      />
  ...
  Starling: (
    <g>
      <path
        d="M-20 6 C-25 -19 -3 -33 17 -27 C33 -22 34 2 20 11 C9 17 -8 19 -20 6 Z"
        fill={C}
      />
      <path
        d="M17 9 C32 9 45 5 54 -1 L50 9 L47 18 C39 15 27 15 17 13 Z"
        fill={C}
      />
      ...
      <path
        d="M-5 16 l0 13 M9 18 l0 12"
        stroke={C}
        strokeWidth="3"
        strokeLinecap="round"
      />
      <path
        d="M-5 29 l-5 4 M-5 29 l5 4 M9 30 l-5 4 M9 30 l5 4"
        stroke={C}
        strokeWidth="2.5"
        strokeLinecap="round"
      />
