...
export const sources = [
  {
    ...
    name: "Codegen",
    description:
      "Typed client artifacts with pluggable validators (zod/valibot/arktype).",
    icon: "Braces",
  ...
  },
  {
    ...
    name: "Filter",
    description:
      "A query filter language with ORM adapters and a typed client.",
    icon: "Filter",
  ...
  },
  {
    ...
    name: "Inertia",
    description:
      "TypeScript-first Inertia.js adapter — multi-app, Vite-native.",
    icon: "Layers",
  ...
  },
  {
    ...
    name: "Media",
    description:
      "Filesystem + media-library in one package — disks, resumable uploads, attachments, conversions.",
    icon: "Image",
  ...
  },
  {
    ...
    name: "Notifications",
    description:
      "Laravel-style notifications — one notification, many channels.",
    icon: "Bell",
  ...
  },
  {
    ...
    name: "Telescope",
    description:
      "Telescope-style observability console with watchers + dashboard.",
    icon: "Telescope",
  ...
  },
  {
    ...
    name: "Resilience",
    description:
      "Composable timeout, retry, circuit-breaker and failover policies — with a pluggable, distributed breaker store.",
    icon: "Zap",
